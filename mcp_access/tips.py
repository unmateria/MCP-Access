...
_TIPS: dict[str, str] = {
    ...
    "lint": (
        ...
        "Layout-quality rules (info only — never change the verdict, never reach\n"
        ...
        "  the form edge), hierarchy (action text smaller than body text).\n"
        "  A form built with access_build_form passes all of them clean.\n\n"
        "Enforcement:\n"
